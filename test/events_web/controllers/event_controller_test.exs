defmodule EventsWeb.EventControllerTest do
  ...
  @create_attrs %{allDay: true, end: "2010-04-17 14:00:00.000000Z", start: "2010-04-17 14:00:00.000000Z", title: "some title"}
  ...
  def fixture(:event) do
    {:ok, event} = Database.create_event(@create_attrs)
    event
  end
